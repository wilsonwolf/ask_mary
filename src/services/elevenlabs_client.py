...
def build_system_prompt(
    *,
    ...
    return (
        ...
        f"tool with their statement. Do NOT call safety_check on routine "
        f"conversation — only when something sounds concerning.\n\n"
        ...
        f"- safety_check: call ONLY when the participant says something "
        f"medically concerning, expresses distress, anger, threats, "
        f"or withdraws consent. Do NOT call on routine conversation.\n\n"
        f"RULES:\n"
